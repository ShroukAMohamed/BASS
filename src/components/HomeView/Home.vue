            ...
            <div class="modal-card" @click.stop>
              ...
              <div>
                ...
                <form @submit.prevent="client_dashboard">
                  <div class="mt-4 mb-4">
                    <input class="d-block" type="submit" value="Client" />
                  </div>
                </form>

                <form @submit.prevent="instructor_dashboard">
                  <div class="mt-4 mb-4">
                    <input class="d-block" type="submit" value="Instructor" />
                  </div>
                </form>

                <form @submit.prevent="developer_dashboard">
                  <div class="mb-5">
                    <input class="d-block" type="submit" value="Developer" />
                  </div>
                </form>
              </div>
            </div>
